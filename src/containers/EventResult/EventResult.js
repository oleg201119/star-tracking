...
class EventResult extends Component {
  ...
  filtertable() {
    this.showtable(this.state.eventID, this.state.categoryID, 0, this.state.sizePerPage, this.state.sortColumn, this.state.sortDirection, this.state.currentlanguage, this.state.filter);
  }
  updatepagesize(e) {
