							...
							<div className="mobile-header d-block d-xl-none">
								...
								>
									...
									<div className="mobile-tab">
										...
										<a
											className={`mobile-tab-item ${tabindex === 1 ? 'selected' : ''}`}
											onClick={() => {
										...
										<a
											className={`mobile-tab-item ${tabindex === 2 ? 'selected' : ''}`}
											onClick={() => {
										...
										<a
											className={`mobile-tab-item ${tabindex === 3 ? 'selected' : ''}`}
											onClick={() => {
										...
										<a
											className={`mobile-tab-item ${tabindex === 4 ? 'selected' : ''}`}
											onClick={() => {
												this.setState({ tabindex: 4 });
												this.closeMenu();
											}}
